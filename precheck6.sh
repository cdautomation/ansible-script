...
echo "--- vgs,pvs-----" >>/home/ansuser/configuration.txt
vgs >> /home/ansuser/configuration.txt
pvs >> /home/ansuser/configuration.txt
...
chkconfig --list >> /home/ansuser/configuration.txt
...
echo "----yum check-update details----" >> /home/ansuser/configuration.txt
yum check-update >> /home/ansuser/configuration.txt
